...
alias bru="brew update; brew upgrade --greedy --no-ask; brew autoremove; brew cleanup --prune=all"
alias ff="fastfetch"
...
alias ytps="yt-dlp --netrc --add-header "Origin: https://www.playsuisse.ch" "
