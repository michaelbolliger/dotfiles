...
alias fitbackup="bsdtar -c --exclude-from=tarignore -vJf ~/Library/Mobile\ Documents/com~apple~CloudDocs/__FITTING\ IN/MC\ PROJECT\ BACKUPS/"$(date '+%y%m%d-%H%M')_fitting_in_avid_project_backup.tar.xz" /Volumes/FIT_Edit1/01\ PROJECT/Avid\ Projekt/FITTING\ IN"
